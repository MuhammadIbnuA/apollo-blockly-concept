...
const EXTENDED_LEVELS: ExtendedPixelArtLevel[] = [
    {
        ...
        allowedBlocks: ['pixel_set_color', 'pixel_draw', 'pixel_move_right'],
    },
    {
        ...
        allowedBlocks: ['pixel_set_color', 'pixel_draw', 'pixel_move_down'],
    },
    {
        ...
        allowedBlocks: ['pixel_set_color', 'pixel_draw', 'pixel_move_right', 'pixel_move_down'],
    },
    {
        ...
        allowedBlocks: ['pixel_set_color', 'pixel_draw', 'pixel_move_right', 'pixel_move_down', 'repeat_times'],
    },
    {
        id: 5, name: 'Seni Bebas', difficulty: 'free',
